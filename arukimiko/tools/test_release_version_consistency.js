...
const loader=text('loader.js'),bootstrap=text('bootstrap.js'),hard=text('bootstrap-v304.js'),guide=text('jinpo-bot-site-guide.js'),bot=text('jinpo-bot.js'),conversation=text('jinpo-bot-conversation.js'),smalltalk=text('jinpo-bot-smalltalk.js'),hero=text('jinpo-bot-hero-knowledge.js'),chat=text('jinpo-ai-chat.js'),source=text('jinpo-bot-site-source-data.js');
...
check('chat UI internal version',chat.includes("version:'1.0.13-local-only'"));
