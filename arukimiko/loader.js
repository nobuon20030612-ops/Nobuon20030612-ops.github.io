/*
 * 歩き巫女 サイト共通ローダー v3.9.0-multiturn-state
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.9.0-multiturn-state',baseUrl:base,pageMode:mode,loading:true,ready:false};
