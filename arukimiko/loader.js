/*
 * 歩き巫女 サイト共通ローダー v3.7.0-compound-conversation
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.7.0-compound-conversation',baseUrl:base,pageMode:mode,loading:true,ready:false};
