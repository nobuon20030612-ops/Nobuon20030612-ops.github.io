/*
 * 歩き巫女 サイト共通ローダー v3.15.0-listening-depth
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.15.0-listening-depth',baseUrl:base,pageMode:mode,loading:true,ready:false};
