/*
 * 歩き巫女 サイト共通ローダー v3.12.0-ai-orchestration
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.12.0-ai-orchestration',baseUrl:base,pageMode:mode,loading:true,ready:false};
