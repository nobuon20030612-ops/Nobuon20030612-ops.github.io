/*
 * 歩き巫女 サイト共通ローダー v3.65.0-local-only
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.65.0-local-only',baseUrl:base,pageMode:mode,loading:true,ready:false};
