/*
 * 歩き巫女 サイト共通ローダー v3.13.0-long-conversation
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.13.0-long-conversation',baseUrl:base,pageMode:mode,loading:true,ready:false};
