/*
 * 歩き巫女 サイト共通ローダー v3.10.0-person-relations
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.10.0-person-relations',baseUrl:base,pageMode:mode,loading:true,ready:false};
