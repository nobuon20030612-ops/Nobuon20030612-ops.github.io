/*
 * 歩き巫女 サイト共通ローダー v3.17.0-stance-branch
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.17.0-stance-branch',baseUrl:base,pageMode:mode,loading:true,ready:false};
