/*
 * 歩き巫女 サイト共通ローダー v3.8.0-natural-continuation
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.8.0-natural-continuation',baseUrl:base,pageMode:mode,loading:true,ready:false};
