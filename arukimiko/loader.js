/*
 * 歩き巫女 サイト共通ローダー v3.16.0-focus-flow
...
(function(){
  ...
  window.ARUKIMIKO_SHARED={version:'3.16.0-focus-flow',baseUrl:base,pageMode:mode,loading:true,ready:false};
