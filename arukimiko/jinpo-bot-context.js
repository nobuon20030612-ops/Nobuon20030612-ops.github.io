...
(function(){
  ...
  function isGeneralLiveFollowup(text){
    return /^(?:(?:それ|これ|その件|さっきの|今の|前の)(?:は|って|について)?[、\s]*)?(?:最近どう(?:なの|ですか)?|今どうなって(?:る|いる)|今どう|今はどう(?:なの|ですか|なんだろう|なんだろ)?|現在はどう(?:なの|ですか|なってる)?|最新は|最新情報は|何か変わった|なにか変わった|変化あった|動きあった)[？?！!。]*$/.test(S(text)) || /^(?:昨日から|きのうから)(?:何か|なにか)?(?:変わった|変化あった|動きあった)[？?！!。]*$/.test(S(text));
  }
