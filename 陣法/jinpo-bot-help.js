(function(){
  ...
  var HELP={
    capabilities:'陣形・5〜9因縁・第1/第2優先・数値範囲・等級3以下・文曲除外人数・おすすめ陣法・検索中止・検索結果表示/並べ替え/比較/適用・配置英傑・除外英傑・配置クリア・差替・因縁判定/因縁一覧・見聞録・鬼神石・転生・全MAX・合計確認・保存編成・共有URL・JSON入出力などを、サイトの既存機能を使って操作できます。誤字・表記揺れも補助し、確信が持てない場合は実行前に『○○ということでよろしいですか？』と確認します。ファイル読込を伴う機能は、サイト上で選択済みのファイルだけを実行します。',
