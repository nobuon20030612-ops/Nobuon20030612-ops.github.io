(function(){
  ...
  function ensureBond56Style(){if(q('jinpoBond56ModeStyle'))return;var st=document.createElement('style');st.id='jinpoBond56ModeStyle';st.textContent=`
    ...
    /* 2026-09-02: 5・6因縁モード中だけ人物画像を7〜10因縁ボタンの上へ重ねる。ボタン自体は残し、下の表示へはみ出さない。 */
    body.jinpo-bond56-mode #dbCountButtons{position:relative!important;padding-bottom:0!important}
    body.jinpo-bond56-mode #dbCountButtons::after{content:"";position:absolute!important;left:30px!important;top:53px!important;width:390px!important;height:260px!important;background:url("assets/jinpo-bond56-cover.png") center/contain no-repeat!important;z-index:40!important;pointer-events:none!important;user-select:none!important}
