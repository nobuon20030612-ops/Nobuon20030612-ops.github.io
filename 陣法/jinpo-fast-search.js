(function(){
  ...
  function syncBond56FormationGuide(){
    ...
    var guide=q('jinpoBond56FormationGuide'),grade=document.querySelector('#dbCountButtons .dbGradeToggleBtn');
    if(guide&&grade&&active){
      guide.style.setProperty('left',grade.offsetLeft+'px','important');
      guide.style.setProperty('top',grade.offsetTop+'px','important');
      guide.style.setProperty('width',grade.offsetWidth+'px','important');
  ...
  function renderUnifiedCountButtons(){
    ...
    box.innerHTML='<button id="jinpoBond56ModeBtn" class="jinpoBond56ModeBtn '+(b56?'active':'')+'" data-bond56-toggle="1" type="button" aria-pressed="'+(b56?'true':'false')+'">5・6因縁モード '+(b56?'ON':'OFF')+'</button>'+
      ...
      '<div id="jinpoBond56FormationGuide" class="jinpoBond56FormationGuide" aria-hidden="true"><span>陣形選択</span><b>↑</b></div>'+
  ...
  function ensureBond56Style(){if(q('jinpoBond56ModeStyle'))return;var st=document.createElement('style');st.id='jinpoBond56ModeStyle';st.textContent=`
    ...
    /* 2026-09-02: 5・6因縁モード中だけ人物画像を7〜10因縁ボタンの上へ重ねる。5・6ボタンは前面に残す。 */
    body.jinpo-bond56-mode #dbCountButtons{position:relative!important;padding-bottom:0!important;overflow:visible!important}
    body.jinpo-bond56-mode #dbCountButtons::after{content:"";position:absolute!important;left:68px!important;top:53px!important;width:360px!important;height:245px!important;background:url("assets/jinpo-bond56-cover.png") center/contain no-repeat!important;z-index:40!important;pointer-events:none!important;user-select:none!important}
    body.jinpo-bond56-mode #dbCountButtons .dbCountBtn[data-count="5"],body.jinpo-bond56-mode #dbCountButtons .dbCountBtn[data-count="6"]{position:relative!important;z-index:55!important}
    body.jinpo-bond56-mode #dbCountButtons .jinpoTenBondGuideImage{display:none!important}
    .jinpoBond56FormationGuide{display:none!important;position:absolute!important;z-index:80!important;pointer-events:none!important;align-items:center!important;justify-content:center!important;gap:9px!important;font-weight:950!important;font-size:22px!important;letter-spacing:.08em!important;color:#fff4a8!important;text-shadow:0 0 6px #ffcc35,0 0 13px #ff7b00,2px 2px 2px #000!important;white-space:nowrap!important}
    .jinpoBond56FormationGuide b{font-size:30px!important;line-height:1!important;color:#74fbff!important;text-shadow:0 0 7px #00edff,0 0 14px #00aaff!important}
    body.jinpo-bond56-mode.jinpo-bond56-formation-unselected #jinpoBond56FormationGuide{display:flex!important;animation:jinpoBond56FormationGuideFloat .85s ease-in-out infinite alternate!important}
  ...
  function syncBond56NobunagaOverlay(){
    ...
    img.style.setProperty('clip-path',clip,'important');
    img.style.setProperty('-webkit-clip-path',clip,'important');
