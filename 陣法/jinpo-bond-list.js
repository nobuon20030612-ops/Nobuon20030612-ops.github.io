...
(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '.jinpoRecommendLabel{flex:0 0 auto;margin-right:5px;padding:5px 8px;border:1px solid rgba(255,218,102,.72);border-radius:9px;background:linear-gradient(180deg,rgba(111,67,11,.46),rgba(53,30,5,.34));color:#ffd866;font-size:18px;font-weight:1000;letter-spacing:.025em;white-space:nowrap;text-shadow:0 0 8px rgba(255,210,73,.58),0 1px 0 rgba(0,0,0,.68);box-shadow:0 0 10px rgba(255,194,50,.20),inset 0 0 7px rgba(255,232,155,.07);transform-origin:center;will-change:transform;animation:jinpoRecommendLabelFloat 1.9s ease-in-out infinite;}',
      'body.jinpo-recommend-active .jinpoRecommendLabel{color:var(--jinpo-rec-accent);border-color:var(--jinpo-rec-accent);text-shadow:0 0 10px var(--jinpo-rec-glow),0 1px 0 rgba(0,0,0,.68);box-shadow:0 0 12px var(--jinpo-rec-glow),inset 0 0 8px var(--jinpo-rec-soft);}',
      '@keyframes jinpoRecommendLabelFloat{0%,100%{transform:translateY(0) scale(1)}50%{transform:translateY(-2px) scale(1.025)}}',
      ...
      '@media(prefers-reduced-motion:reduce){#jinpoRecommendModeBadge.is-active,.jinpoRecommendLabel{animation:none!important;}}',
